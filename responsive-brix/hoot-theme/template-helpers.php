	...
	<div class="entry-byline">
		...
		if ( !empty( $display['author'] ) ) :
			?><div class="entry-byline-block entry-byline-author">
				<span class="entry-byline-label"><?php _e( 'By:', 'responsive-brix' ) ?> </span>
				<span <?php hoot_attr( 'entry-author' ); ?>><?php the_author_posts_link(); ?></span>
			</div><?php
		endif;

		if ( !empty( $display['date'] ) ) :
			?><div class="entry-byline-block entry-byline-date">
				<span class="entry-byline-label"><?php _e( 'On:', 'responsive-brix' ) ?> </span>
				<time <?php hoot_attr( 'entry-published' ); ?>><?php echo get_the_date(); ?></time>
			</div><?php
		endif;
		...
		if ( !empty( $display['cats'] ) ) :
			...
			if ( !empty( $category_list ) ) :
				?><div class="entry-byline-block entry-byline-cats">
					<span class="entry-byline-label"><?php _e( 'In:', 'responsive-brix' ) ?> </span>
		...
		if ( !empty( $display['tags'] ) && get_the_tags() ) :
			?><div class="entry-byline-block entry-byline-tags">
				<span class="entry-byline-label"><?php _e( 'Tagged:', 'responsive-brix' ) ?> </span>
				<?php ( ! get_the_tags() ) ? _e( 'No Tags', 'responsive-brix' ) : the_tags('', ', ', ''); ?>
			</div><?php
		endif;

		if ( !empty( $display['comments'] ) && comments_open() ) :
			?><div class="entry-byline-block entry-byline-comments">
				<span class="entry-byline-label"><?php _e( 'With:', 'responsive-brix' ) ?> </span>
				<?php comments_popup_link(	__( '0 Comments', 'responsive-brix' ),
		...
		if ( $edit_link = get_edit_post_link() ) :
			?><div class="entry-byline-block entry-byline-editlink">
				<a href="<?php echo $edit_link; ?>"><?php _e( 'Edit This', 'responsive-brix' ) ?></a>
			</div><?php
		endif; ?>

...
if ( !class_exists( 'Hoot' ) ) {
	class Hoot {
		...
		function i18n() {
			...
			$hoot->textdomain_loaded[ $parent_textdomain ] = load_theme_textdomain( $parent_textdomain );
			...
			// $hoot->textdomain_loaded['hoot'] = hoot_load_framework_textdomain( 'hoot' );
			// $hoot->textdomain_loaded['hoot'] = hoot_load_framework_textdomain( 'hoot' );
